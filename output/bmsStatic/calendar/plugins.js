...
function fAfterSelected(y,m,d,e) {
  ...
  posx = posx - e.x;
  posy = posy - e.y + 15;
  if(gContainer.showAvailabilityMenu){
    gContainer.showAvailabilityMenu(posx, posy, y, m, d);
  }
  if(gContainer.pickDate){
    gContainer.pickDate(y,m,d);
  }
  if(gContainer.document.demoForm.dateField != null &&
    gContainer.document.demoForm.dateField != undefined){
