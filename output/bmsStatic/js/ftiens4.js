...
{ 
  ...
  this.nodeImg = 0;
  this.isLastNode = 0;
  this.iconSrc = ICONPATH + "//folders/lmm.gif";
  this.iconSrcClosed = ICONPATH + "//folders/lpm.gif";
...
{ 
  ...
  this.iconSrc = ICONPATH + "//folders/doc.png" 
  this.isRendered = 0
  this.isLastNode = false
  this.level = 0
  this.leftSideCoded = ""
...
function preLoadIcons() {
	...
	auxImg.src = ICONPATH + "//folders/lpm.gif";
	auxImg.src = ICONPATH + "//folders/lmm.gif";
	auxImg.src = ICONPATH + "//folder/doc.png";
}
