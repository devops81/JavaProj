...
<%
	...
	if (session.getAttribute("reportID") != null)
		reportID = Long.parseLong((String) session
...
function EmailReport(){
	var r=confirm("This report will be sent to <%=PropertyReader.getInstance().getServerConstantValueFor("MailTo")%>")
  	if (r==true)
    {
	    document.reportViewerForm.action = "<%=CONTEXTPATH%>/reportsViewer.htm?action=<%=ActionKeys.EMAIL_REPORT%>";
		document.reportViewerForm.submit();	
    }
}
</script>
	...
	<tr>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
				...
				%>
				<td width="10%"><span class="text-blue-01-bold">&nbsp;&nbsp;&nbsp;&nbsp;Page
				...
				<td width="89.5%">&nbsp;&nbsp;<img src="images/pdf_icon.gif" border="0" style="cursor: pointer;"
					onclick="javascript:ExportToPdf();"></td>
				<!--td>&nbsp;&nbsp;<img src="images/email_icon.jpg" width="17"
					height="17" border="0" style="cursor: pointer;"
					onclick="javascript:EmailReport();">
				</td-->
			</tr>
		</table>
		<hr size="1" color="#000000">
