...
SPOOL ON
SET HEADING OFF
rem log file : Prasugrel_Reactive_DCI_v2.log
SPOOL Prasugrel_Reactive_DCI_v2.log
SET ECHO ON
...
update SURVEYMETADATA set name = 'Prasugrel Reactive DCI v2 Ended_'||( select to_char(sysdate, 'MM/DD/YYYY') from dual ), DATE_END = ( select to_char(sysdate, 'MM/DD/YYYY') from dual ) where name = 'Prasugrel Reactive DCI v2';

delete from FEATURE_USERGROUP_MAP where FEATURE_ID in ( select id from SURVEYMETADATA where name = 'Prasugrel Reactive DCI v2 Ended_'||( select to_char(sysdate, 'MM/DD/YYYY') from dual ) ) and PERMISSION_ON_FEATURE = 3;

rem ------------------------------------------------------------------------------------------------------------------------------------------------------------

Insert into "SURVEYMETADATA" ("ID","NAME","TYPE","STATE","ACTIVE","DATE_START","DATE_END") 
values (HIBERNATE_SEQUENCE.NEXTVAL,'Prasugrel Reactive DCI v2','DCI','Launched','true', ( select to_char(sysdate, 'MM/DD/YYYY') from dual ), ( select to_char(sysdate + numtoyminterval(1, 'YEAR'), 'MM/DD/YYYY') from dual ));
...
execute CREATE_SURVEY_QA(' HCP Specialty','multioptsinglesel','Prasugrel Reactive DCI v2','false','1');
...
execute CREATE_SURVEY_QA(' KTL/OL Tier','multioptsinglesel','Prasugrel Reactive DCI v2','false','2');
...
insert into answer_options_temp values ('No (skip to question 16)',2);

execute CREATE_SURVEY_QA(' Did the HCP mention prasugrel?','multioptsinglesel','Prasugrel Reactive DCI v2','false','3');

delete from answer_options_temp;

rem -------------------------------------------------------------------------------------------------------

insert into answer_options_temp values ('Will routinely use prasugrel (proceed to questions 6-15)',1);
insert into answer_options_temp values ('Will use cautiously in select patients (proceed to questions 6-15)',2);
insert into answer_options_temp values ('Not planning to use prasugrel (proceed to questions 5-7, then - question 16)',3);
insert into answer_options_temp values ('Will not use prasugrel until more data available (proceed to questions 5-7, then - question 16)',4);
insert into answer_options_temp values ('Did not comment (skip to question 16)',5);

execute CREATE_SURVEY_QA(' Did the HCP state how he/she will use prasugrel in his/her individual clinical practice?','multioptsinglesel','Prasugrel Reactive DCI v2','false','4');
...
execute CREATE_SURVEY_QA(' If HCP does not plan on using prasugrel, what rationale did they provide? (Select all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','5');
...
execute CREATE_SURVEY_QA(' Did the HCP mention prasugrel''s black box warning, highlighting bleeding risks?','multioptsinglesel','Prasugrel Reactive DCI v2','false','6');
...
execute CREATE_SURVEY_QA(' If yes to #6, please check all specific bleeding risks mentioned:','multioptmultisel','Prasugrel Reactive DCI v2','false','7');
...
execute CREATE_SURVEY_QA(' If the HCP is planning on using prasugrel, did the HCP comment on any factors that may influence treatment decisions around use of prasugrel in clinical practice? (Select all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','8');
...
execute CREATE_SURVEY_QA(' Did the HCP comment in which patient populations prasugrel may be utilized? (check all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','9');
...
execute CREATE_SURVEY_QA(' If HCP commented on prescribing prasugrel for patients at low risk of bleeding, how would they define ''''low risk'''' of bleeding? (Select all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','10');
...
execute CREATE_SURVEY_QA(' Did the HCP mention any patient sub-groups in which prasugrel may be specifically avoided? (Select all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','11');
...
execute CREATE_SURVEY_QA(' Within the patient populations where prasugrel may be used by the HCP, did the HCP mention any patient sub-groups in which a lower maintenance dose of prasugrel may be used?  (Select all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','12');
...
execute CREATE_SURVEY_QA(' If the HCP plans on using prasugrel in ACS patients who are candidates for PCI, did the HCP comment on which strategy will be chosen?','multioptsinglesel','Prasugrel Reactive DCI v2','false','13');
...
execute CREATE_SURVEY_QA(' If the HCP is planning on using prasugrel, did they comment on how long they would continue it?','multioptsinglesel','Prasugrel Reactive DCI v2','false','14');
...
execute CREATE_SURVEY_QA(' Since prasugrel is contraindicated in patients with a history of TIA/Stroke, did the HCP indicate how they would determine who has had a history of TIA/Stroke? (Select all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','15');
...
insert into answer_options_temp values ('YES',1);
insert into answer_options_temp values ('NO (skip to PLATO - question 27 )',2);

execute CREATE_SURVEY_QA(' Did the TL inquire about the CURRENT/OASIS 7 results presented at the ESC 2009 Meeting?','multioptsinglesel','Prasugrel Reactive DCI v2','false','16');
...
insert into answer_options_temp values ('NO (skip to question 27)',3);

execute CREATE_SURVEY_QA(' Was the TL familiar with the data presented at the ESC 2009 Meeting?','multioptsinglesel','Prasugrel Reactive DCI v2','false','17');
...
execute CREATE_SURVEY_QA(' Did the TL comment on their overall perspective of CURRENT:','multioptsinglesel','Prasugrel Reactive DCI v2','false','18');
...
execute CREATE_SURVEY_QA(' Did the TL comment on the efficacy data from the CURRENT/OASIS 7 Trial? (select all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','19');
...
execute CREATE_SURVEY_QA(' Did the TL comment on the clinical relevance of the safety profile from CURRENT?','multioptsinglesel','Prasugrel Reactive DCI v2','false','20');
...
execute CREATE_SURVEY_QA(' As a result of CURRENT, did the TL offer comment on which dosing scheme may be utilized when treating ACS patients with an early invasive strategy involving PCI?','multioptsinglesel','Prasugrel Reactive DCI v2','false','21');
...
execute CREATE_SURVEY_QA(' As a result of CURRENT, did the TL offer comment on the timing of the dosing scheme that may be utilized:','multioptsinglesel','Prasugrel Reactive DCI v2','false','22');

delete from answer_options_temp;

rem -------------------------------------------------------------------------------------------------------

insert into answer_options_temp values ('Yes (skip to question 26)',1);
insert into answer_options_temp values ('No',2);
insert into answer_options_temp values ('Did not comment (skip to question 27)',3);

execute CREATE_SURVEY_QA(' Does the TL think CURRENT will change clinical practice?','multioptsinglesel','Prasugrel Reactive DCI v2','false','23');
...
execute CREATE_SURVEY_QA(' If ''''No'''' to question 23, what was their rationale? (Select all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','24');
...
execute CREATE_SURVEY_QA(' If ''''No'''' to question 23, how will the TL treat patients that undergo an early invasive strategy:','multioptsinglesel','Prasugrel Reactive DCI v2','false','25');
...
execute CREATE_SURVEY_QA(' If ''''Yes'''' to question 23 in  patients presenting with ACS that undergo early invasive strategy, will results of the CURRENT/OASIS 7 Trial influence the TL to modify their existing approach to anti-platelet therapy:','multioptsinglesel','Prasugrel Reactive DCI v2','false','26');
...
execute CREATE_SURVEY_QA(' Did HCP mention PLATO or ticagrelor? (If yes, proceed with question 28)','multioptsinglesel','Prasugrel Reactive DCI v2','false','27');

delete from answer_options_temp;

rem -------------------------------------------------------------------------------------------------------

insert into answer_options_temp values ('Will use ticagrelor when available (Goto question 30)',1);
insert into answer_options_temp values ('Will use cautiously when available (Goto question 30)',2);
...
execute CREATE_SURVEY_QA(' Did the HCP state how he/she may use ticagrelor in his/her individual clinical practice?','multioptsinglesel','Prasugrel Reactive DCI v2','false','28');
...
execute CREATE_SURVEY_QA(' If the HCP does not plan on using ticagrelor, what rationale did they provide? (Select all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','29');
...
execute CREATE_SURVEY_QA(' If the HCP is planning on using ticagrelor, did the HCP comment on any factors that may influence treatment decisions around use of ticagrelor in clinical practice? (Select all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','30');
...
execute CREATE_SURVEY_QA(' Did the HCP comment in which patient populations ticagrelor may be utilized? (check all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','31');
...
execute CREATE_SURVEY_QA(' If the HCP plans on using ticagrelor in ACS patients who are candidates for PCI, did the HCP comment on which strategy will be chosen?','multioptsinglesel','Prasugrel Reactive DCI v2','false','32');
...
execute CREATE_SURVEY_QA(' If the HCP is planning on using ticagrelor, did they comment on how long they would continue it?','multioptsinglesel','Prasugrel Reactive DCI v2','false','33');
...
execute CREATE_SURVEY_QA(' If the HCP is not planning on using ticagrelor for the length it was studied in the trial, what is the rational?  (Select all that apply)','multioptmultisel','Prasugrel Reactive DCI v2','false','34');
...
execute CREATE_SURVEY_QA(' Did the HCP comment on how results of PLATO are interpreted in light of their knowledge of CURRENT?','multioptsinglesel','Prasugrel Reactive DCI v2','false','35');
...
execute CREATE_SURVEY_QA(' Did the HCP state whether this would impact clinical practice?','multioptsinglesel','Prasugrel Reactive DCI v2','false','36');
...
values (HIBERNATE_SEQUENCE.NEXTVAL, (select id from SURVEYMETADATA where name = 'Prasugrel Reactive DCI v2'),
...
rem : 2>Purpose         	: Script to create the new "Prasugrel Reactive DCI v2"
rem : 3>Date of creation	: 15-Sep-2009
